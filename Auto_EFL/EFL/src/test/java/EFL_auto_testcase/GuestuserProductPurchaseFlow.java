...
public class GuestuserProductPurchaseFlow extends TestBase{
	loginPage login;
	PDP P;
	Cart c;
	Home hom;
...
/*	@Test
	...
	@Test(priority=1,groups="Page",dependsOnGroups="loginTest",dataProvider = "Selectcategory",enabled=true)
	   public void HomePageFunction(String WayToClickOnMenu,String SearchData,String selectData,String PinCodeData,String FullNameData,String MobileNumberData,String Runmode) throws Throwable {
   ...
   public void Categorypage(String WayToClickOnMenu,String SearchData,String selectData,String PinCodeData,String FullNameData,String MobileNumberData,String Runmode) throws Throwable {
   if(Runmode.equalsIgnoreCase("n")) {
	   throw new SkipException("Not executed with this records");  
   }
  hom.Selectcategory(WayToClickOnMenu, SearchData,selectData,PinCodeData,FullNameData,MobileNumberData);
   ...
   public void PDP_Page(String WayToBuy,String Runmode,String ExecutionMode) throws Exception{
   if(Runmode.equalsIgnoreCase("n")) {
	throw new SkipException("Not executed with this records");  
	}
    P.CheckDeliveryFor();
	...
	@Test(priority=4,groups="addtobag",dependsOnGroups="product",dataProvider = "PDP_Page",enabled=true)
	   public void MiniCartCheck (String ThingtoApplyPromocode,String PromocodeData,String Runmode,String ExecutionMode) throws Exception {
		   ...
		   c.CartPage(ThingtoApplyPromocode, PromocodeData);
		if(ExecutionMode.equalsIgnoreCase("Valid")) {	
		try {
	...
	@Test(priority=5,groups="Checkout",dependsOnGroups="addtobag",dataProvider = "Checkout",enabled=true)
	   public void CheckoutAndPaymentGatewayVerification(String WayOfCheckout,String mobiledata,String FirstName,String lastName,String Mobile_Number,String Email_Id,String house_noData,String Street_Data,String Street1_Data,String PinCode_Data,String City_Data,String selectRegion,String Runmode,String ExecutionMode) throws Exception {
		   if(Runmode.equalsIgnoreCase("n")) {
			   throw new SkipException("Not executed with this records");  
		   }
